...
public class BoardController {
	...
	public String insertBoard(BoardVO vo, BoardDAO boardDAO) { // HttpServletRequest
																// request
		// else if (path.equals("/insertBoard.do")) { // loginBoard.do ->
		// insertBoard.do
	...
	public String getBoard(BoardVO vo, BoardDAO boardDAO, Model model) {
		...
		// Model 정보 저장
		model.addAttribute("board", boardService.getBoard(vo)); // List
		return "getBoard.jsp";
