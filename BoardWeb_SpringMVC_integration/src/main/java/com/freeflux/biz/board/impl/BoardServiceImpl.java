...
public class BoardServiceImpl implements BoardService {
	...
	public void insertBoard(BoardVO vo) {
		// Transaction Test
		this.boardDAO.insertBoard(vo);	// seq 占쏙옙 100占쏙옙 占쏙옙占쏙옙 : 占쏙옙占쏙옙 占쏙옙占싱븝옙 占쌔댐옙 占쏙옙占쏙옙 占쏙옙占쌕곤옙 占쏙옙占쏙옙
//		this.boardDAO.insertBoard(vo);	// seq 占쏙옙 100占쏙옙 占쏙옙占쏙옙 : primary key 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쌩삼옙
	}
